        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-400 font-sans leading-relaxed">
              Soluções completas de engenharia, construção e reformas de alto padrão. Cuidamos do seu projeto com transparência, capricho e respeito aos prazos combinados.
            </p>
